...
func (s *CITAScheduleHandler) newEffectiveSchedule(jobType k8upv1.JobType) k8upv1.EffectiveSchedule {
...
func (s *CITAScheduleHandler) synchronizeEffectiveSchedulesResources() error {
...
func (s *CITAScheduleHandler) getEffectiveSchedule(jobType k8upv1.JobType, originalSchedule k8upv1.ScheduleDefinition) k8upv1.ScheduleDefinition {
...
func (s *CITAScheduleHandler) findExistingSchedule(jobType k8upv1.JobType, originalSchedule k8upv1.ScheduleDefinition) (k8upv1.ScheduleDefinition, bool) {
...
func (s *CITAScheduleHandler) setEffectiveSchedule(jobType k8upv1.JobType, schedule, originalSchedule k8upv1.ScheduleDefinition) {
	es, found := s.effectiveSchedules[jobType]
	if !found {
...
func (s *CITAScheduleHandler) UpsertResource(obj client.Object) error {
...
func (s *CITAScheduleHandler) cleanupEffectiveSchedules(jobType k8upv1.JobType, newSchedule k8upv1.ScheduleDefinition) {
	es, found := s.effectiveSchedules[jobType]
	if !found {
		return
	}
...
func (s *CITAScheduleHandler) DeleteResource(obj client.Object) error {
