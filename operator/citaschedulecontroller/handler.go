...
func NewScheduleHandler(config job.Config, schedule *citav1.Schedule, logger logr.Logger) *ScheduleHandler {
...
func (s *ScheduleHandler) createJobList(ctx context.Context) error {
	...
	for jobType, jb := range map[k8upv1.JobType]objectInstantiator{
		citav1.CITAPruneType: {spec: s.schedule.Spec.CITAPrune, ctor: func(spec citav1.ScheduleSpecInterface) k8upv1.JobObject {
			return &citav1.Prune{Spec: spec.(*citav1.CITAPruneSchedule).PruneSpec}
		}},
		citav1.CITABackupType: {spec: s.schedule.Spec.CITABackup, ctor: func(spec citav1.ScheduleSpecInterface) k8upv1.JobObject {
			return &citav1.Backup{Spec: spec.(*citav1.CITABackupSchedule).BackupSpec}
		}},
		citav1.CITARestoreType: {spec: s.schedule.Spec.CITARestore, ctor: func(spec citav1.ScheduleSpecInterface) k8upv1.JobObject {
			return &citav1.Restore{Spec: spec.(*citav1.CITARestoreSchedule).RestoreSpec}
		}},
	} {
...
func keyOf(schedule *citav1.Schedule, jobType k8upv1.JobType) string {
